    ...
    <div class="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center p-4">
        ...
        <div class="bg-white p-6 rounded-lg shadow-lg max-h-full overflow-y-auto" style="min-width: 600px;">
            ...
            <div class="flex justify-between items-center mb-3">
                <h2 class="text-xl font-bold">Criar Categoria</h2>
                <!-- Botão de Fechar -->
            ...
            <form wire:submit='save'>
                ...
                <div class="mb-4 linha-sub-tarefa">
                    ...
                    <div class="flex-col">
                        ...
                        <select id="subCategory" wire:model.live="subCategory" class="block appearance-none bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline">
                    ...
                    @if($subCategory == 1)
                        ...
                        <div class="mb-4">
                            ...
                            <select id="form.category" wire:model.live="form.related_id"
