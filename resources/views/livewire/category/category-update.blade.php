            ...
            <form wire:submit='update'>
                ...
                <div class="mb-4 linha-sub-tarefa">
                    ...
                    @if($subCategory == 1)
                        <!-- Categoria -->
                        <div class="mb-4">
                            <label for="form.related_id" class="block text-gray-700 text-sm font-bold mb-2">Categoria:</label>
                            <select id="form.related_id" wire:model.live="form.related_id" @if($dataToModal) disabled @endif
